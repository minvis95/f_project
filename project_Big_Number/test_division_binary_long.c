...
//Verification
int  test_division_binary_long_verification()
{
	...
	while ((cnt_i > 0))
	{
		...
		//binary_long word version
		division_binary_long(&X, &Y, &Q, &R);
...
//Performance
#if 0
int test_division_binary_long_performance()
{
